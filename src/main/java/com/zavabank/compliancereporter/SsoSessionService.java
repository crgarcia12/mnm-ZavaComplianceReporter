...
public class SsoSessionService {
    public static final String SESSION_USER = "zavaComplianceReporter.user";
    ...
    public String extractToken(HttpServletRequest request) {
        ...
        String cookieName = ComplianceConfig.getSsoCookieName();
    ...
    private String resolveTokenFromAuthGateway(String cookieName, String cookieValue) {
        String whoAmIUrl = normalize(ComplianceConfig.getAuthGatewayWhoAmIUrl());
